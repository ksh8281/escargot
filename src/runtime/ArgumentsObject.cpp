    ...
    , m_argc((argc << 1) | 1)
{
    ...
    if (isMapped) {
        ...
        m_values[ESCARGOT_OBJECT_BUILTIN_PROPERTY_NUMBER + 1] = sourceFunctionObject;
        ...
        m_values[ESCARGOT_OBJECT_BUILTIN_PROPERTY_NUMBER + 2] = state.context()->globalObject()->arrayPrototypeValues();
    } else {
